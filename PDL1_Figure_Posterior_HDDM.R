...
#
bar1 <- grobTree(textGrob("_______", x=0.40,  y=0.85, hjust=0, gp=gpar(col="black", fontsize=12, fontface="italic")))
pr1 <- grobTree(textGrob("Pr = 0.974", x=0.43,  y=0.86, hjust=0, gp=gpar(col="black", fontsize=8, fontface="italic")))
#
bar2 <- grobTree(textGrob("________", x=0.38,  y=0.75, hjust=0, gp=gpar(col="black", fontsize=12, fontface="italic")))
pr2 <- grobTree(textGrob("Pr = 0.972", x=0.41,  y=0.76, hjust=0, gp=gpar(col="black", fontsize=8, fontface="italic")))
#
...
bar1 <- grobTree(textGrob("________", x=0.45,  y=0.85, hjust=0, gp=gpar(col="black", fontsize=12, fontface="italic")))
pr1 <- grobTree(textGrob("Pr = 0.985", x=0.48,  y=0.86, hjust=0, gp=gpar(col="black", fontsize=8, fontface="italic")))
#
bar2 <- grobTree(textGrob("_______________", x=0.28,  y=0.95, hjust=0, gp=gpar(col="black", fontsize=12, fontface="italic")))
pr2 <- grobTree(textGrob("Pr > 0.999", x=0.39,  y=0.96, hjust=0, gp=gpar(col="black", fontsize=8, fontface="italic")))
#
bar3 <- grobTree(textGrob("______", x=0.27,  y=0.85, hjust=0, gp=gpar(col="black", fontsize=12, fontface="italic")))
pr3 <- grobTree(textGrob("Pr = 0.968", x=0.28,  y=0.86, hjust=0, gp=gpar(col="black", fontsize=8, fontface="italic")))
...
bar1 <- grobTree(textGrob("_______", x=0.32,  y=0.85, hjust=0, gp=gpar(col="black", fontsize=12, fontface="italic")))
pr1 <- grobTree(textGrob("Pr = 0.992", x=0.34,  y=0.86, hjust=0, gp=gpar(col="black", fontsize=8, fontface="italic")))
#
bar2 <- grobTree(textGrob("________________", x=0.31,  y=0.95, hjust=0, gp=gpar(col="black", fontsize=12, fontface="italic")))
pr2 <- grobTree(textGrob("Pr > 0.999", x=0.46,  y=0.96, hjust=0, gp=gpar(col="black", fontsize=8, fontface="italic")))
#
bar3 <- grobTree(textGrob("________", x=0.52,  y=0.85, hjust=0, gp=gpar(col="black", fontsize=12, fontface="italic")))
pr3 <- grobTree(textGrob("Pr = 0.995", x=0.54,  y=0.86, hjust=0, gp=gpar(col="black", fontsize=8, fontface="italic")))
...
bar1 <- grobTree(textGrob("_________", x=0.32,  y=0.85, hjust=0, gp=gpar(col="black", fontsize=12, fontface="italic")))
pr1 <- grobTree(textGrob("Pr = 0.999", x=0.37,  y=0.86, hjust=0, gp=gpar(col="black", fontsize=8, fontface="italic")))
#
bar2 <- grobTree(textGrob("__________________", x=0.31,  y=0.95, hjust=0, gp=gpar(col="black", fontsize=12, fontface="italic")))
pr2 <- grobTree(textGrob("Pr > 0.999", x=0.47,  y=0.96, hjust=0, gp=gpar(col="black", fontsize=8, fontface="italic")))
#
bar3 <- grobTree(textGrob("_______", x=0.58,  y=0.85, hjust=0, gp=gpar(col="black", fontsize=12, fontface="italic")))
pr3 <- grobTree(textGrob("Pr = 0.993", x=0.59,  y=0.86, hjust=0, gp=gpar(col="black", fontsize=8, fontface="italic")))
...
bar1 <- grobTree(textGrob("______", x=0.29,  y=0.85, hjust=0, gp=gpar(col="black", fontsize=12, fontface="italic")))
pr1 <- grobTree(textGrob("Pr = 0.978", x=0.30,  y=0.86, hjust=0, gp=gpar(col="black", fontsize=8, fontface="italic")))
#
bar2 <- grobTree(textGrob("__________________", x=0.28,  y=0.95, hjust=0, gp=gpar(col="black", fontsize=12, fontface="italic")))
pr2 <- grobTree(textGrob("Pr > 0.999", x=0.42,  y=0.96, hjust=0, gp=gpar(col="black", fontsize=8, fontface="italic")))
#
bar3 <- grobTree(textGrob("__________", x=0.47,  y=0.85, hjust=0, gp=gpar(col="black", fontsize=12, fontface="italic")))
...
bar1 <- grobTree(textGrob("_________", x=0.37,  y=0.85, hjust=0, gp=gpar(col="black", fontsize=12, fontface="italic")))
pr1 <- grobTree(textGrob("Pr = 0.987", x=0.40,  y=0.86, hjust=0, gp=gpar(col="black", fontsize=8, fontface="italic")))
#
bar2 <- grobTree(textGrob("___________", x=0.37,  y=0.95, hjust=0, gp=gpar(col="black", fontsize=12, fontface="italic")))
pr2 <- grobTree(textGrob("Pr = 0.998", x=0.44,  y=0.96, hjust=0, gp=gpar(col="black", fontsize=8, fontface="italic")))
#
...
bar1 <- grobTree(textGrob("__________", x=0.385,  y=0.85, hjust=0, gp=gpar(col="black", fontsize=12, fontface="italic")))
pr1 <- grobTree(textGrob("Pr = 0.987", x=0.44,  y=0.86, hjust=0, gp=gpar(col="black", fontsize=8, fontface="italic")))
...
pr1 <- grobTree(textGrob("Pr = 0.997", x=0.44,  y=0.86, hjust=0, gp=gpar(col="black", fontsize=8, fontface="italic")))
#
bar2 <- grobTree(textGrob("_______", x=0.48,  y=0.75, hjust=0, gp=gpar(col="black", fontsize=12, fontface="italic")))
pr2 <- grobTree(textGrob("Pr = 0.962", x=0.50,  y=0.76, hjust=0, gp=gpar(col="black", fontsize=8, fontface="italic")))
